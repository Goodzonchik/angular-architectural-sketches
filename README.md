...
- Повышается консистентность кода
...
- Для форматирования кода не потребуется, чтобы у всех разработчиков были одинаковые настройки форматирования, хук сделает работу за разработчика
...
- Импортировать функцию проще и правильне, чем использовать сервис
