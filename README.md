...
- Можно сделать команду **yarn install && yarn start** (или что-то похожее под ангуляр). При старте будет проверка всех пакетов. Потеря по времени (0,5-5 секунд на старт) компенсируется решением проблемы отсутствующего пакета (если никто не сказал, что добавил новый пакет в зависимости)
...
## Более грамотно и мелко - Файлы стилей
